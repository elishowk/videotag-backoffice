...
<div id="speakerModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="ModalLabel-speaker" aria-hidden="true">
    <div class="modal-header">
        ...
        <p>Les personnalités sont des profils "VIP" dont les commentaires apparaissent d'une couleur différente et sont mis en avant.</br>
          ...
          Celle-ci recevra un mail automatique l'informant de votre choix et de la date de l'événement</em></p>
    </div>
